...
<style>
    ...
    #planoEstagio, #termoEstagio{margin-top: 20px; border-top: solid 3px #e5e5e5; padding-top: 10px;}
    .input-hora{display: inline; max-width: 65px;}
    .label-dia{min-width: 140px; text-align: right;}
    .form-control{margin-bottom: 10px}
    .col-3{ width: 33%; min-width: 340px; float: left; min-height: 289px; padding-left: 10px; margin: auto;}
    ...
    @media (max-width: 1200px) {
        .col-3{width: 50%; padding-right: 50px;}
    }
