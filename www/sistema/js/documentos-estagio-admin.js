$(document).ready(function(){
		...
		$("tr[name=plano]").click(function(e){
            ...
            $("#myModalLabel").html("Plano de Atividades");
            $("#myModalBody").empty();
            ...
            //determina o metodo
            xmlhttp.open("POST","plano_de_atividades_admin.php", true);
		...
		$("tr[name=relatorio]").click(function(e){
			$("#myModalLabel").html("Relátorio");
				...
				//determina o metodo
				xmlhttp.open("POST","relatorio-admin.php", true);
