<?php 
	...
	<script src="js/jquery.maskedinput.js"></script>
		...
		<?php
			...
			$query = mysqli_query($mysqli,"SELECT * FROM plano_de_atividades WHERE Id_Plano_De_Atividades='".$_POST["plano"]."' AND Id_Estagio='".$idEstagio."' AND Id_Aluno='".$_SESSION["id"]."'") or die(mysqli_error($mysqli));
		...
		<div class="row">
			<form method="post" action="Controllers/Controller-mudar-plano-de-atividades.php">
				...
				<div class="col-xs-12 col-md-2">	
						...
						<center><b>Data<?php echo $erros[2]==1?'<span id="1" class="glyphicon  glyphicon-comment" value="'.$comentarioRow['Comentario_Data'].'" style="cursor:pointer;margin-left: 5px;color:#45AB35" ></span>':"" ?></b></center><input type="text"  boolt="<?php echo $erros[2];?>" class="plano-local" id="data" value="<?php echo DateTime::createFromFormat("Y-m-d" ,$planoRow['Data'])->format("d-m-Y");  ?>" name="data" ><br><br>
				</div>
