<?php 
	...
	if( isset($_POST['Modalidade'],$_POST['Codigo_Area'],$_POST['Codigo_Empresa'],$_POST['dataInicial'],$_POST['dataFinal'],$_POST['Codigo_Supervisor']
		 ,$_POST['descricao'],$_POST['local'],$_POST['horarios'],$_POST['data']) ){
		...
		insereEstagio($mysqli,$Modalidade,$Codigo_Area,$Codigo_Empresa,$DataInicial,$DataFinal,$Codigo_Supervisor,$Numero);
		
		$idEstagio = mysqli_insert_id($mysqli);
		...
		$_SESSION["Success"] = "Estágio enviado para aprovação.";
		header("Location:../meus-estagios.php"); /* Redirect browser */
		exit();
