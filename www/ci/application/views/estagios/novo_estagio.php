...
<link rel="stylesheet" href="<?php echo base_url('includes/bootstrap/_css/bootstrap-datepicker3.css') ?>">
<script src="<?php echo base_url('includes/bootstrap/_js/bootstrap-datepicker.js') ?>"></script>
<script src="<?php echo base_url('includes/bootstrap/_js/bootstrap-datepicker.pt-BR.min.js') ?>"></script>
<script src="<?php echo base_url('includes/bootstrap/_js/novo-estagio.js') ?>"></script>
...
<form method="post" enctype="multipart/form-data" action="<?= base_url('/insere_estagio')?>">
